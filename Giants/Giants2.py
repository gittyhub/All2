...
if __name__=='__main__':
  ...
  siter = get_AllLinks1(site, date) #grabs all links for the above site with 5/15 in it but you may run into a situation where its in the title and not body, what about 5/15-5/18
  #print(len(siter))
  #print(sys.argv[1])
  k = find_n_sort_monies(siter, date) 
  #print(len(k)) 
  for c in k:
    print(c)
